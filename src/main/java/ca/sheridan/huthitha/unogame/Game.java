...
* This class represents a Game object. It contains fields and methods related to the status of
...
firstCom = new Hand("Zarina", 7);
secondCom = new Hand("Timothy", 7);
thirdCom = new Hand("Prithvi", 7);
...
**/
public void play(App u) {

Hand [] players = {user, firstCom, secondCom, thirdCom};
String [] names = {"You", "Zarina", "Timothy", "Prithvi"};
