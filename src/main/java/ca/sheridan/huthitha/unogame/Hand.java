...
*This class represents a Hand object
It is a subclass of Deck. It contains methods that relate to actions of a computer player.
*/
import java.util.*;
...
int which = App.rint(0, playableNormal.size()-1);
...
int which = App.rint(0, playableOther.size()-1);
...
int which = App.rint(0, wilds.size()-1);
