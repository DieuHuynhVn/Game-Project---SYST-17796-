 ...
 */
package ca.sheridan.huthitha.unogame;

/**
 * Project: Uno game for SYST 17796
 * Huynh team ( Dieu, Zarina, Timothy, Prithvi)
 */
import javax.swing.*;
import java.awt.*;
...
setTitle("Application of Uno game");
setSize(1000, 800);
setLocation(200, 50);
...
lNames = new JLabel[4];
lNames[0] = nameLabel;
JLabel zarina = new JLabel ("Zarina has 7 cards");
setLabelFormat(zarina, 150, 100);
addToComputerPanel(zarina, 1, 0, 1, 1);
lNames[1] = zarina;
JLabel timothy = new JLabel ("Timothy has 7 cards");
setLabelFormat(timothy, 150, 100);
addToComputerPanel(timothy, 2, 0, 1, 1);
lNames[2] = timothy;
JLabel prithvi = new JLabel ("Prithvi has 7 cards");
setLabelFormat(prithvi, 150, 100);
addToComputerPanel(prithvi, 3, 0, 1, 1);
lNames[3] = prithvi;
...
String [] names = {usersName, "Zarina", "Timothy", "Prithvi"};
...
App f = (App) SwingUtilities.getRoot(box);
...
App u = (App) SwingUtilities.getRoot(button);
...
App u = (App) SwingUtilities.getRoot(b);
